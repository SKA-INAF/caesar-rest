...
class AegeanAppConfigurator(AppConfigurator):
	...
	def __init__(self, app_name="aegean"):
		...
		json_catalog_out_format= (
			...
			'    - ra_str/dec_str | str: Island centroid J2000 Right-Ascension/Declination position in sexigecimal format\n'
		...
		ascii_catalog_out_format= (
			...
			'- Col 5: ra_str | str: Island centroid J2000 Right-Ascension position in sexigecimal format\n'
			'- Col 6: dec_str | str: Island centroid J2000 Declination position in sexigecimal format\n'
			'- Col 7: ra | float: Island centroid J2000 Right-Ascension position (unit: deg)\n'
			'- Col 8: dec | float: Island centroid J2000 Declination position (unit: deg)\n'
		...
		ascii_fitcomp_catalog_out_format= (
			...
			'- Col 3: bkg | float: Background flux density (unit: Jy/beam)\n'
			'- Col 4: rms | float: Local noise rms (unit: Jy/beam)\n'
			'- Col 5: ra_str | str: Component centroid J2000 Right-Ascension position in sexigecimal format\n'
			'- Col 6: dec_str | str: Component centroid J2000 Declination position in sexigecimal format\n'
			'- Col 7-8: ra/ra_err | float: Component centroid J2000 Right-Ascension position and its error (unit: deg)\n'
			'- Col 9-10: dec/dec_err | float: Component centroid J2000 Declination position and its error (unit: deg)\n'
